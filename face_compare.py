...
print('aaa')
fail = [0 for i in range(5)]
diff = [0 for i in range(5)]
dist_avg = [0 for i in range(5)]
...
for i in range(400):
    img_input='result_openface/imgs/input%03d.png'%(i)
    ...
    img_overall='result_openface/imgs/overall%03d.png'%(i)
